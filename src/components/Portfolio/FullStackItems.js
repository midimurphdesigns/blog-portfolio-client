...
const items = [
  {
    ...
    description: 'An app that allows users to search for live music in their area and invite friends to shows they\'ve found.',
    meta: 'React, Redux, MongoDB, Node, Express',
    extra: <a href="https://concertconnect-client.herokuapp.com/" target="_blank">https://concertconnect-client.herokuapp.com/</a>,
  },
  {
    childKey: 1,
