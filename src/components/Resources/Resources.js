...
export default function Resources(props) {
  return (
    <div className="page-container">
      ...
      <h2 className="resources-page-subtitle">
        A personally curated list of articles, tutorials, books, and more
      </h2>
      <div className="index">
      ...
      <div className="">
        <div className="category">
          <h3 className="category-title" id="general-web-development">
            General Web Development
          </h3>
          <ul>
            <li>
            ...
            <li>
              <a
                ...
                target="_blank"
              >
                33 Useful Youtube channels for learning web design and
                development
              </a>
            </li>
            <li>
            ...
            <li>
              <a
                ...
                target="_blank"
              >
                The Net Ninja web development youtube videos
              </a>
            </li>
            <li>
              <a
        ...
        <div className="category">
          <h3 className="category-title" id="general-javascript">
            General JavaScript
          </h3>
          <ul>
            <li>
            ...
            <li>
              <a
                ...
                target="_blank"
              >
                You Don't Know JavaScript - A book that goes VERY in depth into
        ...
        <div className="category">
          <h3 className="category-title" id="react">
            React JS
          </h3>
          <ul>
            <li>
              <a
                ...
                target="_blank"
              >
                React JS video tutorials on youtube
              </a>
            </li>
            <li>
              <a
            ...
            <li>
              <a
                ...
                target="_blank"
              >
                React Router V4 video tutorial
              </a>
            </li>
            <li>
              <a
      ...
      <div className="">
        <div className="category">
          <h3 className="category-title" id="html-css">
            HTML/CSS
          </h3>
          <ul>
            <li>
            ...
            <li>
              <a
                ...
                target="_blank"
              >
                How CSS works: Parsing & painting CSS in the critical rendering
                path
              </a>
            </li>
            <li>
        ...
        <div className="category">
          <h3 className="category-title" id="node-express">
            Node & Express
          </h3>
          <ul>
            <li>
            ...
            <li>
              <a
                ...
                target="_blank"
              >
                Scaling NodeJS beyond the ordinary | JSConf Iceland 2018
              </a>
            </li>
            <li>
              <a
        ...
        <div className="category">
          <h3 className="category-title" id="mongodb">
            MongoDB
          </h3>
          <ul>
            <li>
              <a
                ...
                target="_blank"
              >
                MongoDB In 30 Minutes - Traversy Media
              </a>
            </li>
            <li>
              <a
      ...
      <div className="">
        <div className="category">
          <h3 className="category-title" id="postgresql">
            PostgreSQL
          </h3>
          <ul>
            <li>
            ...
            <li>
              <a
                ...
                target="_blank"
              >
                SQL Tutorial for Beginners 1: Installing PostgreSQL and Creating
                Your First Database
              </a>
            </li>
            <li>
        ...
        <div className="category">
          <h3 className="category-title" id="design-ux">
            Design & UX
          </h3>
          <ul>
            <li>
              <a
                ...
                target="_blank"
              >
                The ‘UI and UX Design’ Pocket Guide
              </a>
            </li>
            <li>
              <a
            ...
            <li>
              <a
                ...
                target="_blank"
              >
                I/O 2018: Google's Definitive Guide to Design
              </a>
            </li>
            <li>
              <a
            ...
            <li>
              <a
                ...
                target="_blank"
              >
                4 Psychology Principles Web Designers Must Know
              </a>
            </li>
          </ul>
        </div>
          ...
          <ul>
            ...
            <li>
              <a
                ...
                target="_blank"
              >
                Accessible Color Palette - Contrasting Text Pairs with
            ...
            <li>
              <a
                ...
                target="_blank"
              >
                Name that Color - Better Color Names with Color Name & Hue
              </a>
            </li>
            <li>
              <a
